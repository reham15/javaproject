  ...
  FXMLDocumentController t;
    ...
    public Client() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FXMLDocument.fxml"));
            window = loader.load();
 t =loader.< FXMLDocumentController>getController();
        
 Scene scene = new Scene(window);
       //Stage stage=(Stage)((Node)event.getSource()).getScene().getWindow();
       //Stage stage=Javaproject.stage;
      JavaFXApplication7.stage.setScene(scene);
       JavaFXApplication7.stage.show();
  ...
  /*public ObservableList<User>  obeerveList( List<User> u)
  {  ObservableList<User> obUsers=FXCollections.observableArrayList();
  
 obUsers= FXCollections.observableArrayList( users);
 
 for(int i=0;i<5;i++)
 System.out.println(obUsers.get(i).getUserName());
